...
public class Field : MonoBehaviour
{
    ...
    void Update()
    {
        if (_canDrawConnection)
        {
            ...
            _mouseGridX = (int)Mathf.Floor(_mouseWorldPosition.x - 100);
            _mouseGridY = (int)Mathf.Floor(_mouseWorldPosition.y - 100);
    ...
    void onTileSelected(Tile tile)
    {
        ...
        else
        {
            ...
            if (isFirstTileInConnection) tile.HighlightReset();
